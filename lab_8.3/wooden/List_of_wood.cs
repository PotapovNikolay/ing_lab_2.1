...
namespace lab_8._3
{
    public class List_of_wood
    {

        public int filtercoating;

        public List<Plywood> list_of_plywood = new List<Plywood>();

        public List<DVP> list_of_dvp = new List<DVP>();

        public List<DSP> list_of_dsp = new List<DSP>();
        ...
        public List<Block_parquet> list_of_blockparguet = new List<Block_parquet>();

        public List<Laminate> list_of_laminate = new List<Laminate>();

        public List<Massive_parquet> list_massive_parguet = new List<Massive_parquet>();

        public List<Parquet_board> list_of_parquet_board = new List<Parquet_board>();
        ...
        public void add_massive_parquet(int Length, int Width, int Thickness, string Name, string type_of_wood, int Coating)
        {
